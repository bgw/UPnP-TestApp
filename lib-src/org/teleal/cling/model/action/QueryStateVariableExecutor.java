 ...
 */
public class QueryStateVariableExecutor extends ActionExecutor {
    ...
    protected void executeQueryStateVariable(ActionInvocation<LocalService> actionInvocation, Object serviceImpl) throws Exception {
        ...
        String stateVariableName = actionInvocation.getInput().getValues()[0].toString();
        ...
        try {
            setOutputArgumentValues(actionInvocation, accessor.read(stateVariable, serviceImpl).toString());
        } catch (Exception ex) {
