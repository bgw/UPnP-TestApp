...
public abstract class OutgoingNotificationRequest extends OutgoingDatagramMessage<UpnpRequest> {
    ...
    protected OutgoingNotificationRequest(InetAddress localAddress, int localStreamPort,
        ...
        getHeaders().add(
                ...
                new LocationHeader(
                        URIUtil.createAbsoluteURL(localAddress, localStreamPort, device.getDescriptorURI())
                )
        );
